...
pub fn build() -> Library {
    ...
    let feeds = vec![
        Feed {
            id: "f-heise".into(),
            title: "heise online".into(),
            website: Some("https://www.heise.de".into()),
            accent: "#B94A2E".into(),
            groups: vec!["g-tech".into()],
        },
        Feed {
            id: "f-lobsters".into(),
            title: "Lobsters".into(),
            website: Some("https://lobste.rs".into()),
            accent: "#AC3A50".into(),
            groups: vec!["g-tech".into()],
        },
        Feed {
            id: "f-tagesschau".into(),
            title: "tagesschau.de".into(),
            website: Some("https://www.tagesschau.de".into()),
            accent: "#2E5FA3".into(),
            groups: vec!["g-news".into()],
        },
        Feed {
            id: "f-design".into(),
            title: "Formfollows Blog".into(),
            website: Some("https://example.org/blog".into()),
            accent: "#3F8F5F".into(),
            groups: vec!["g-design".into()],
        },
    ];
...
{rest}"#,
    ...
    add(
        "a-heise-3",
        "f-heise",
        "BSI warnt vor aktiver Ausnutzung einer Lücke in cups",
        Some("Jo Stein"),
        "https://example.com/cups",
        9,
        "Drucker-Dienste sollten abgeschirmt werden; Patches stehen bereit.",
        true,
        false,
        false,
        short_paras("Sicherheit", 3),
    );
    add(
        "a-heise-4",
        "f-heise",
        "Kommentar: Der Desktop-Jahrgang 2026 ist ein guter",
        Some("Ada Lorenz"),
        "https://example.com/kommentar",
        28,
        "Wayland, Portale und schnelle Toolkits greifen endlich ineinander.",
        false,
        false,
        false,
        short_paras("Kommentar", 5),
    );
    ...
    add(
        "a-lob-1",
        "f-lobsters",
        "Show: A tiny Wayland compositor in 900 lines of Rust",
        Some("pixelpusher"),
        "https://example.com/tinycomp",
        3,
        "Ein Lehrstück über wlroots, damage tracking und Eingaberouting.",
        true,
        false,
        true,
        short_paras("Compositor", 4),
    );
    ...
    add(
        "a-lob-3",
        "f-lobsters",
        "The hidden cost of double buffering",
        Some("gfxguru"),
        "https://example.com/buffering",
        12,
        "Warum Frame-Budgets kippen, wenn Present-Zeitpunkte wandern.",
        true,
        false,
        false,
        short_paras("Grafik", 5),
    );
    add(
        "a-lob-4",
        "f-lobsters",
        "Ask: Which RSS reader do you use on Linux in 2026?",
        Some("curiouscat"),
        "https://example.com/askrss",
        20,
        "Große Umfrage mit überraschend vielen GTK-Nennungen.",
        false,
        false,
        false,
        short_paras("Umfrage", 2),
    );
    ...
    add(
        "a-lob-6",
        "f-lobsters",
        "GTK 4.22 released with SVG widget",
        None,
        "https://example.com/gtk422",
        50,
        "Das Toolkit bekommt native SVG-Darstellung und Feinschliff an Listen.",
        false,
        false,
        false,
        short_paras("GTK", 3),
    ...
    add(
        "a-ts-1",
        "f-tagesschau",
        "Haushaltsdebatte: Investitionen und Schuldenbremse",
        Some("Anja Vogel"),
        "https://example.com/haushalt",
        1,
        "Die Fraktionen streiten über den Etat; Abstimmung am Freitag.",
        true,
        false,
        true,
        short_paras("Politik", 4),
    );
    ...
    add(
        "a-ts-3",
        "f-tagesschau",
        "Unwetterwarnung für den Süden aufgehoben",
        None,
        "https://example.com/unwetter",
        10,
        "Der Deutsche Wetterdienst gibt Entwarnung für die Alpenregion.",
        true,
        false,
        false,
        short_paras("Wetter", 2),
    );
    add(
        "a-ts-4",
        "f-tagesschau",
        "Analyse: Was das neue Klimagesetz vorsieht",
        Some("Tom Berger"),
        "https://example.com/klima",
        26,
        "Sektorziele, Berichtspflichten und der Streit um die Nachsteuerung.",
        false,
        false,
        false,
        short_paras("Analyse", 5),
    );
    add(
        "a-ts-5",
        "f-tagesschau",
        "Bahn kündigt Winter-Fahrplan an",
        None,
        "https://example.com/bahn",
        30,
        "Mehr ICE-Sprinter, weniger Nachtbaustellen ab Dezember.",
        true,
        false,
        false,
        short_paras("Verkehr", 3),
    );
    add(
        "a-ts-6",
        "f-tagesschau",
        "Kulturerbe: Anträge für immaterielle Liste",
        None,
        "https://example.com/kultur",
        55,
        "Zwölf neue Vorschläge stehen zur Entscheidung.",
        false,
        false,
        false,
        short_paras("Kultur", 2),
    );

    add(
        "a-des-1",
        "f-design",
        "Typografie-Skala für Lese-Apps",
        Some("Lina Marsh"),
        "https://example.com/type-scale",
        4,
        "Von 14 px UI-Text bis 36 px Überschrift: eine konsistente Skala bauen.",
        true,
        false,
        false,
        short_paras("Typografie", 4),
    );
    add(
        "a-des-2",
        "f-design",
        "Dichte ohne Unruhe: Informationsdesign für Artikellisten",
        Some("Ole Brandt"),
        "https://example.com/dichte",
        14,
        "Warum feste Zeilenhöhen und reservierte Bildflächen Ruhe erzeugen.",
        true,
        false,
        true,
        short_paras("Listen", 5),
    );
    add(
        "a-des-3",
        "f-design",
        "Farbtokens: Ein System für GTK-CSS und Reader",
        Some("Lina Marsh"),
        "https://example.com/tokens",
        29,
        "Semantische Namen statt Hex-Literale — in beiden Renderern.",
        false,
        true,
        false,
        short_paras("Farbe", 4),
    ...
    add(
        "a-des-4",
        "f-design",
        "Fokus sichtbar machen, ohne zu schreien",
        None,
        "https://example.com/fokus",
        48,
        "Fokusringe, die Kontrastregeln erfüllen und trotzdem dezent bleiben.",
        true,
        false,
        false,
        short_paras("A11y", 3),
    ...
    add(
        ...
        72,
        "Ein Schalter, der Übergänge abschaltet, ohne Funktionen zu verlieren.",
        false,
        false,
        false,
        short_paras("Motion", 2),
    );
